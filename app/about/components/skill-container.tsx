...
const getIcons = (name: string) => {
    const iconMap: Record<string, JSX.Element> = {
        CodeXml: <CodeXml className="group-hover:text-indigo-500"/>,
        Braces: <Braces className="group-hover:text-indigo-500"/>,
        Cloud: <Cloud className="group-hover:text-indigo-500"/>,
        Database: <Database className="group-hover:text-indigo-500"/>,
        Wrench: <Wrench className="group-hover:text-indigo-500"/>,
        Layers: <Layers className="group-hover:text-indigo-500"/>,
    }
